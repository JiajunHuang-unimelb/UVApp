...
| EP-03 | Sensor-Driven Exposure Context Detection | Leverage device onboard sensors (light sensor, proximity sensor, optional rear camera) to classify real-time sun-exposure state. Supports automatic countdown pause when phone is placed inside a pocket. |
